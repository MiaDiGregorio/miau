...
<head>
  ...
  <link href="https://fonts.googleapis.com/css?family=Amatic+SC|Bangers|Paytone+One" rel="stylesheet">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <li class="nav-item active">
          <a class="nav-link" href="preguntas.php">FAQ<span class="sr-only">(current)</span></a>
        </li>
      </ul>
    </div>
  </nav>
