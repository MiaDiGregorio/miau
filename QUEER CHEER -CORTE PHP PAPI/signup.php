...
<body>
    ...
    <form class="text-center border border-0 p-5 col-md-4  center_div__ " method="$_POST" action="funciones.php">   
        ...
        <!-- Usuario -->
        <input name="name" type="usuario" id="defaultRegisterFormUser" class="form-control mb-4" placeholder="Usuario">

        <!-- E-mail -->
        <input name="email" type="email" id="defaultRegisterFormEmail" class="form-control mb-4" placeholder="E-mail">

        <!-- Password -->
        <input name="password" type="password" id="defaultRegisterFormPassword" class="form-control mb-4 " placeholder="Password" aria-describedby="defaultRegisterFormPasswordHelpBlock">
        
        <input name="repassword" type="password" id="defaultRegisterFormPassword" class="form-control mb-4 " placeholder="Confirma el password" aria-describedby="defaultRegisterFormPasswordHelpBlock">
