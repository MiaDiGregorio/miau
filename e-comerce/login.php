            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                  ...
                  <li class="nav-item">
                    <a class="nav-link active" href="login.php">Ingresá <span class="sr-only">(current)</span></a>
                  </li>
                  <li class="nav-item">
    ...
    <div class="container">
       <!--loginn-->
        <div class="logincontainer login">
                <form action="procesar.php" method="post"  class="text-center border border-0 p-5 col-md-4  center_div__ ">   
                   ...
                   No recuerdas tu <a href="">contraseña</a> ?
                    </div>       
                       <!--password-->     
                       <label for="h4 mb-4 text-white validationServer03"></label>
